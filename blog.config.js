...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'theme-fukasawa', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || ture, // 是否显示切换主题
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '三川品牌', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我出色，你精彩。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ipsup.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '知鹰, 品牌, 商标,策划 , 宣传', // 网站关键词 英文逗号隔开
